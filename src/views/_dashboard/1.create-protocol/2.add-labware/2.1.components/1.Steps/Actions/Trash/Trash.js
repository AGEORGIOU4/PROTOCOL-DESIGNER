...
export const TrashForm = ({ onClose, onDelete, stepId, stepTitle }) => {
  ...
  const deleteButtonLabel = () => {
    ...
    return selectedLabware.size === labwareOptions.length
      ? "Delete All"
      : "Delete";
  };
            ...
            <CCol md={12}>
              {currentLabwareOptions.length > 0 ? (
                <CFormCheck
                  ...
                  checked={
                    selectedLabware.size === currentLabwareOptions.length
                  }
                  id="selectAll"
                />
              ) : (
              ...
              {currentLabwareOptions.map((option, index) => (
                ...
                >
                  ...
                  {index === currentLabwareOptions.length - 1 &&
                    selectedLabware.size > 0 && (
