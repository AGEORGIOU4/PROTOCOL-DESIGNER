              ...
              <CRow className="mt-4 mb-2">
                ...
                <CCol md={1} style={{ marginLeft: "-56px" }}>
                  <CTooltip
                    ...
                    content="In the time lapse setting, enter the number of seconds you want between each photo; this will be the interval at which the pictures are taken."
                    placement="right"
                ...
                {isPhotoVideoOn && (
                  <>
                    <CRow>
                      <CCol md={2}>
                        <CFormLabel htmlFor="quantityAction">
                          Quantity
                        </CFormLabel>
                        <CFormInput
                          min="0"
                      ...
                      <CCol md={2}>
                        <CFormLabel htmlFor="timeLapseActionVideoPhoto">
                          Time Lapse
                        </CFormLabel>
                        <CFormInput
                          min="0"
