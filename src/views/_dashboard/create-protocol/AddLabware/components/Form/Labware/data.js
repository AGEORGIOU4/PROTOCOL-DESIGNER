...
export const well_plates = [
  ...
  {
    id: 13,
    label: 'Opentrons Tough 96 Well Plate 200 µL PCR Full Skirt',
    value: 'Opentrons Tough 96 Well Plate 200 µL PCR Full Skirt',
    squared: false,

    name: 'Opentrons Tough 96 Well Plate 200 µL PCR Full Skirt',
    max_volume: '200 μL',
    well_count: 96,
    well_shape: 'V-bottom',
    rows: 8,
