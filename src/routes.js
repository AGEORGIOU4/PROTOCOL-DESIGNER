...
const CreateProtocol = React.lazy(
  () => import("./views/_dashboard/1.create-protocol"),
);
const AddLabware = React.lazy(
  () => import("./views/_dashboard/1.create-protocol/2.add-labware"),
);

const ImportProtocol = React.lazy(
  () => import("./views/_dashboard/2.import-protocol/ImportProtocol"),
);
...
const LoadingButtons = React.lazy(
  () => import("./views/buttons/loading-buttons/LoadingButtons"),
);
